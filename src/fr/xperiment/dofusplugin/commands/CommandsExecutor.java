...
public class CommandsExecutor implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String string, String[] args) {
		...
		if (string.equalsIgnoreCase("class")){
			...
			classMenu.setItem(1, CustomItems.getItem(Material.ARROW,"§2Cra",Arrays.asList("§6[Dofus]","Cliquez pour choisir la classe §2Cra§r !")));
			classMenu.setItem(3, CustomItems.getItem(Material.SPAWNER,"§2Osamodas",Arrays.asList("§6[Dofus]","Cliquez pour choisir la classe §2Osamodas§r !")));
			classMenu.setItem(5, CustomItems.getItem(Material.TNT,"§2Roublard",Arrays.asList("§6[Dofus]","Cliquez pour choisir la classe §2Roublard§r !")));
			classMenu.setItem(7, CustomItems.getItem(Material.WITHER_SKELETON_SKULL,"§2Sram",Arrays.asList("§6[Dofus]","Cliquez pour choisir la classe §2Sram§r !")));
			
			classMenu.setItem(19, CustomItems.getItem(Material.CHAIN,"§2Sacrieur",Arrays.asList("§6[Dofus]","Cliquez pour choisir la classe §2Sacrieur§r !")));
			classMenu.setItem(21, CustomItems.getItem(Material.CLOCK,"§2Xelor",Arrays.asList("§6[Dofus]","Cliquez pour choisir la classe §2Xelor§r !")));
			...
			classMenu.setItem(25, CustomItems.getItem(Material.IRON_SWORD,"§2Iop",Arrays.asList("§6[Dofus]","Cliquez pour choisir la classe §2Iop§r !")));
